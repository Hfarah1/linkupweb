 ...
 */
final class Version20250414064305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE events CHANGE description description LONGTEXT DEFAULT NULL, CHANGE imagePath image_path VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE events DROP FOREIGN KEY FK_5387574AC9486A13');
        $this->addSql('ALTER TABLE events CHANGE description description TEXT DEFAULT NULL, CHANGE image_path imagePath VARCHAR(255) DEFAULT NULL');
